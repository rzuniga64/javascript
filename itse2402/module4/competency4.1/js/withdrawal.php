...
<!DOCTYPE html >
<head>
    <title>Express Bank | Withdrawal</title>
...
<body>
    ...
    <div class="container">
        <div class="starter-template">
            <form  method="post" action="subtractBalance.php" enctype="application/x-www-form-urlencoded" role="form" class="form">
                <h1 id="h1">Express Bank </h1><br />
                <fieldset class="scheduler-border">           
                    <?php
                        echo "<p>Your starting account balance: " ;
                        printf ( "%01.2f", $returnValue ) ;
                        echo "</p>" ;
                    ?>
                    <p>withdrawal amount:
                        <input type="text" name= "withdrawalAmount" id="withdrawalAmount" />
                    </p>
                    <p><input type="submit" id="make" value="Make WithDrawal"/></p>
                </fieldset>
            </form>
        </div>
    </div>
